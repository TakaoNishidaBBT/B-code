...
$tree_config = array(
	'id'			=> 'tree',
	'start_html'	=> '<div id="tree" class="bframe_tree bframe_scroll bframe_adjustparent">',
	'end_html'		=> '</div>',
	'script'		=>
	array(
		'bframe_tree'	=>
		array(
			...
			array(
				...
				'tab_scroll'	=>
				array(
					'left'		=> 'tab_scroll_left',
					'right'		=> 'tab_scroll_right',
				),
				'folder_container'	=>
				array(
					'id'		=> 'folder_container',
			...
			'download_progress_id'		=> 'progressDialog',
